        ...
        <div class="container">
            <div class="success-card">
                ...
                <div class="action-buttons">
                    <a href="track.php?track=<?= htmlspecialchars($tracking_number) ?>" class="btn-primary">Track Your Order</a>
                    <a href="index.php" class="btn-outline">Back to Home</a>
                </div>
                
                <div class="contact-info">
                    <p>Need help? Contact us at <strong>info@lugomax.co.uk</strong> or call <strong>+44 20 1234 5678</strong></p>
                </div>
            </div>
        </div>
    </section>
